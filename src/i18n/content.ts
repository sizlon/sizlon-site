    ...
    services: {
      search: {
        ...
        faq: [
          ...
          { q: '우리 쪽에서 시간을 얼마나 내야 하나요?', a: '담당자 기준 총 3~4시간입니다 — 권한 발급 30분, 골든셋 검수 2시간(질의마다 "나와야 하는 문서"를 고르는 일), 1주차 말 점검 30분, 결과 발표 1시간. 그 밖에 재측정용 인덱스를 고객 클러스터에 준비하는 엔지니어 시간 1~2시간이 별도로 듭니다. 절차서와 설정 파일은 드립니다.' },
